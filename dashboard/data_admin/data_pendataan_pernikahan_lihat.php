                                    ...
                                    <div class="row">
                                        ...
                                        <?php 
                                            if(isset($_POST['kembali'])){
                                                ...
                                                function load(){
                                                   window.location='data_pendataan_pernikahan.php';
                                                }
                                                setTimeout('load()',100);
                                                </script>
                                                ";
                                                ...
                                                <form method="post" action="" enctype="multipart/form-data">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="form-group " >
                                                            ...
                                                            <img id="thumbnil"  src="../../pendataan/pendataan/<?php echo $results['suami_ktp_pernikahan']; ?>" class="img-fluid" style="max-width:100px;max-height:100px"><br/>
                                                        ...
                                                        <div class="form-group " >
                                                            ...
                                                            <img id="thumbnil1"  src="../../pendataan/pendataan/<?php echo $results['istri_ktp_pernikahan']; ?>" class="img-fluid" style="max-width:100px;max-height:100px"><br/>
