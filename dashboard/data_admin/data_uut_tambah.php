            ...
            <div class="container">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Tambah Data Ucapan Ulang Tahun</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /.container-fluid -->
                                    ...
                                    <div class="row">
                                        <?php 
                                            if(isset($_POST['submit'])){
                                               ...
                                               $query = "INSERT INTO info_uut(judul_uut,gambar_uut,isi_uut) values('$judul_uut','$gambar_namanya','$isi_uut')";
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="card card-primary">
                                                <div class="card-header">
                                                    <h4 class="card-title">Tambah Data Ucapan Ulang Tahun</h4>
                                                </div>
                                                <!-- /.card-header -->
                                                <!-- form start -->
                                                <form method="post" action="" enctype="multipart/form-data">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="judul_uut" placeholder="Judul Ucapan Ulang Tahun" required>
                                                        </div>
                                                        <div class="form-group " >
                                                            ...
                                                            <input type="file" onchange="showMyImage(this)" class="form-control" name="gambar_uut" value="<?php $results['gambar_uut']; ?>" placeholder="img" required >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="isi_uut">Isi Ucapan Ulang Tahun</label>
                                                            <textarea class="textarea" name="isi_uut" value="" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                                        </div>
                                                    </div>
                                                    <!-- /.card-body -->
