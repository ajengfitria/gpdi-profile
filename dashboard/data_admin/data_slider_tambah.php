                                    ...
                                    <div class="row">
                                        <?php 
                                            if(isset($_POST['submit'])){
                                               ...
                                               $query = "INSERT INTO slider(gambar_slider) values('$gambar_namanya')";
                                                ...
                                                <form method="post" action="" enctype="multipart/form-data">
                                                    <div class="card-body">
                                                        <div class="form-group " >
                                                            ...
                                                            <input type="file" onchange="showMyImage(this)" class="form-control" name="gambar_slider" value="<?php $results['gambar_slider']; ?>" placeholder="img" required >
                                                        </div>
                                                    </div>
                                                    <!-- /.card-body -->
