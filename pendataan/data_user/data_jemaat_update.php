            ...
            <div class="container">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Update Data Anggota Jemaat</h1>
                            </div>
                        </div>
                    </div>
                    <!-- /.container-fluid -->
                                        ...
                                        <?php 
                                            if(isset($_POST['update'])){
                                               ...
                                               if($gambar_name === ''){
                                                  ...
                                                  $gambar_namanya = $results['ktp_anggota'];}
                                               else{
                                                   $file = $results['ktp_anggota'];
                                                   unlink($file);
                                               ...
                                               $query = "UPDATE data_anggota set nama_anggota='$nama_anggota', ktp_anggota='$gambar_namanya', jns_kelamin_anggota='$jns_kelamin_anggota', gol_darah_anggota='$gol_darah_anggota', tmpt_lahir_anggota='$tmpt_lahir_anggota', tgl_lahir_anggota='$tgl_lahir_anggota', tgl_pndftrn_anggota='$tgl_pndftrn_anggota', alamat_anggota='$alamat_anggota', telepon_anggota='$telepon_anggota', pndh_kota_anggota='$pndh_kota_anggota', pndh_gereja_anggota='$pndh_gereja_anggota', id_user='$id_user' WHERE id_anggota='$id_anggota'";
                                               $result = mysqli_query($con,$query);
                                               echo "
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="card card-primary">
                                                <div class="card-header">
                                                    <h4 class="card-title">Update Data Anggota Jemaat</h4>
                                                </div>
                                                <!-- /.card-header -->
                                                <!-- form start -->
                                                <form method="post" action="" enctype="multipart/form-data">
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="nama_anggota" value="<?php echo $results['nama_anggota']; ?>" >
                                                        </div>
                                                        <div class="form-group " >
                                                            ...
                                                            <input type="file" onchange="showMyImage(this)" class="form-control" name="ktp_anggota" value="<?php $results['ktp_anggota']; ?>" placeholder="img" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="jns_kelamin_anggota">Jenis Kelamin</label> 
                                                            <select id="jns_kelamin_anggota" name="jns_kelamin_anggota" class="form-control">
                                                            <?php
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select id="gol_darah_anggota" name="gol_darah_anggota" class="form-control">
                                                            <?php
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" name="tmpt_lahir_anggota" value="<?php echo $results['tmpt_lahir_anggota']; ?>" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="tgl_lahir_anggota">Tanggal Lahir</label>
                                                            <input type="date" class="form-control" name="tgl_lahir_anggota" value="<?php echo $results['tgl_lahir_anggota']; ?>" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="tgl_pndftrn_anggota">Tanggal Pendaftaran</label>
                                                            <input type="date" class="form-control" name="tgl_pndftrn_anggota" value="<?php echo $results['tgl_pndftrn_anggota']; ?>" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="alamat_anggota">Alamat</label>
                                                            <input type="text" class="form-control" name="alamat_anggota" value="<?php echo $results['alamat_anggota']; ?>" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="telepon_anggota">Telepon</label>
                                                            <input type="text" class="form-control" name="telepon_anggota" value="<?php echo $results['telepon_anggota']; ?>" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="pndh_kota_anggota">Pindah Kota</label>
                                                            <input type="text" class="form-control" name="pndh_kota_anggota" value="<?php echo $results['pndh_kota_anggota']; ?>" >
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="pndh_gereja_anggota">Pindah Gereja</label>
                                                            <input type="text" class="form-control" name="pndh_gereja_anggota" value="<?php echo $results['pndh_gereja_anggota']; ?>" >
                                                        </div>                                                        
                                                    </div>
                                                    <!-- /.card-body -->
