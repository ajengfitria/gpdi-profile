                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="invoice p-3 mb-3">
                                    <div class="row mb-3">
                                        <div class="col-10">
                                            <a href="data_kelahiran_tambah.php" class="btn btn-secondary btn-sm">Tambah Data</a>                                                                                 
                                        </div>
                                        <!-- /.col -->
                                    </div>
                                    <!-- Table row -->
                                                ...
                                                <tbody>
                                                    <?php 
                                                        ...
                                                        while($results = mysqli_fetch_assoc($res)){     
                                                           ...
                                                           <a href='data_kelahiran_lihat.php?id_kelahiran=".$results['id_kelahiran']."' class='btn btn-secondary btn-sm'><b>Lihat</b></a> | 
                                                           <a href='data_kelahiran_update.php?id_kelahiran=".$results['id_kelahiran']."' class='btn btn-secondary btn-sm'><b>Update</b></a> |
                                                           <a href='data_kelahiran_hapus.php?id_kelahiran=".$results['id_kelahiran']."' class='btn btn-secondary btn-sm'><b>Hapus</b></a>
                                                           </tr>";}?>
                                                </tbody>
                                            </table>
                                        </div>
