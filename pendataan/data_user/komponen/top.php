...
<html>
    <head>
        ...
        <title>Dashboard Pendataan - <?php echo $results['nama_website']; ?></title>
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="#" onClick="window.location.reload();" class="d-block">Dashboard Pendataan</a>
                    </div>
                </div>
                <!-- Sidebar Menu -->
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class='nav-item'>
                            <a href='data_pernikahan.php' class='nav-link'>
                                <i class='nav-icon fas fa-newspaper'></i>
                                <p>
                                    Pernikahan
                                </p>
                        ...
                        <li class='nav-item'>
                            <a href='data_kelahiran.php' class='nav-link'>
                                <i class='nav-icon fas fa-newspaper'></i>
                                <p>
                                    Kelahiran
                                </p>
